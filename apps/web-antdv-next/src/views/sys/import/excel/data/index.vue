...
import { Card, Result, Steps } from 'antdv-next';
  ...
  <Page auto-content-height>
    ...
    >
      <Steps
        ...
        :current="current"
        :items="[
          { title: '上传数据', description: '上传Excel文件' },
          { title: '导入规则', description: '匹配模版字段' },
          { title: '查看数据', description: '预览解析数据' },
          { title: '导入数据', description: '保存' },
        ]"
      />
