...
import { Button, Card, Col, Divider, Row, Space } from 'antdv-next';
...
<template>
  <Page>
    <Row :gutter="16">
      <Col :xl="24" :xxl="12">
        <Card variant="outlined" class="mb-4" title="基础按钮">
      ...
      <Col :xl="24" :xxl="12">
        <Card variant="outlined" class="mb-4" title="常用按钮 - 默认尺寸">
          <Space :wrap="true">
            <ButtonAdd />
            <ButtonCancel />
            <ButtonEdit />
        ...
        <Card variant="outlined" title="常用按钮 - 表格操作列">
          <Space :wrap="true">
