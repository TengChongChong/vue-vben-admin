...
<template>
  ...
  >
    <Row :gutter="16">
      <Col :xl="24" :xxl="12">
        <Card variant="outlined" class="mb-4" title="头像剪裁 - 方形">
        ...
        <Card variant="outlined" class="mb-4" title="头像剪裁 - 圆形">
        ...
        <Card variant="outlined" title="头像剪裁 - 自定义尺寸">
          <Cropper
      ...
      <Col :xl="24" :xxl="12">
        <Card variant="outlined" title="在表单中使用">
          <BaseForm />
        </Card>
      </Col>
    </Row>
