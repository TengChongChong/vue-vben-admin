...
import type { AntTreeNodeDropEvent } from 'antdv-next/lib/tree';
...
import { Alert, Space, Tree } from 'antdv-next';
...
<template>
  <Drawer class="w-[600px]" title="部门排序">
    <Alert
      banner
      class="mb-2"
      message="拖动节点更改部门顺序或结构"
      type="info"
    />
    <Alert
      banner
