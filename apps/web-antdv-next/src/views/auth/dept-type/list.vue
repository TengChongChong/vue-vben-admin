...
import { Button, Divider, Space } from 'antdv-next';

import { useVbenVxeGrid } from '#/adapter/vxe-table';
import {
  addSysDeptTypeApi,
  getSysDeptTypeApi,
  removeSysDeptTypeApi,
  selectSysDeptTypeApi,
} from '#/api';
  ...
  proxyConfig: {
    ajax: {
      query: async (_, formValues) => {
        return await selectSysDeptTypeApi({ ...formValues });
      },
    },
  },
};
