...
import { Button, Checkbox, message, Space, TypographyText } from 'antdv-next';
...
<template>
  <div class="generator-form">
    <h4>点击生成将生成以下文件</h4>
    <div class="my-4 rounded-sm border">
      <ul class="divide-y text-sm">
        <li v-for="item in generatorFileArray" :key="item" class="px-4 py-2">
          {{ item }}
        </li>
      </ul>
    </div>
