...
import { Card, Steps } from 'antdv-next';
  ...
  <Page content-class="generator">
    <Card variant="outlined">
      <Steps
        :current="current"
        :items="[
          { title: '基本信息', description: '基本信息设置' },
          { title: '列表页面', description: '查询条件与表格排序' },
          { title: '详情页面', description: '录入页面组件排序' },
          { title: '导入&导出', description: '导入及导出字段排序' },
          { title: '完成', description: '生成文件' },
        ]"
      />
