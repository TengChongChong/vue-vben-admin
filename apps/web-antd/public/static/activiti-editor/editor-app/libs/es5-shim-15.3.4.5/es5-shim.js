...
const _Array_slice_ = prototypeOfArray.slice;
...
if (
    ...
    Date.prototype.toISOString = function toISOString() {
        let result, length, value, year, month;
        if (!isFinite(this)) {
