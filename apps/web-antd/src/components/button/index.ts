...
export { default as ButtonInfo } from './src/components/button-info.vue';
export { default as ButtonRemove } from './src/components/button-remove.vue';
export { default as ButtonReset } from './src/components/button-reset.vue';
export { default as ButtonSave } from './src/components/button-save.vue';
export { default as ButtonSubmit } from './src/components/button-submit.vue';
