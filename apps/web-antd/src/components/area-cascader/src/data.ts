import { findNode } from '@vben/utils';
...
export function getAreaName(code?: string): string {
  ...
  return findNode(AREA, (n) => n.value === code)?.label;
}
...
export const AREA = [
  {
    ...
    children: [
      ...
      { value: '110228', label: '密云区' },
      { value: '110229', label: '延庆区' },
    ],
  },
  {
    value: '120000',
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { value: '130603', label: '莲池区' },
          { value: '130621', label: '满城区' },
          { value: '130622', label: '清苑区' },
          { value: '130623', label: '涞水县' },
          { value: '130624', label: '阜平县' },
          { value: '130625', label: '徐水区' },
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { value: '220281', label: '桦甸市' },
          { value: '220282', label: '蛟河市' },
    ...
    children: [
      {
        ...
        children: [
          ...
          { value: '320124', label: '溧水区' },
          { value: '320125', label: '高淳区' },
        ],
      },
      {
        value: '320200',
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { value: '371624', label: '沾化区' },
          { value: '371625', label: '博兴县' },
          { value: '371626', label: '邹平市' },
        ],
      },
      {
        value: '371700',
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { value: '450821', label: '桂平市' },
          { value: '450881', label: '平南县' },
        ],
      },
      {
        value: '450900',
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        label: '三沙市',
        children: [
          { value: '460300', label: '南沙区' },
          { value: '460300', label: '西沙区' },
        ],
      },
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { value: '530821', label: '宁洱哈尼族彝族县' },
          { value: '530822', label: '墨江哈尼族县' },
          { value: '530823', label: '景东彝族县' },
          { value: '530824', label: '景谷傣族彝族县' },
          { value: '530825', label: '镇沅彝族哈尼族拉祜族县' },
          { value: '530826', label: '江城哈尼族彝族县' },
          { value: '530827', label: '孟连傣族拉祜族佤族县' },
          { value: '530828', label: '澜沧拉祜族县' },
          { value: '530829', label: '西盟佤族县' },
        ],
      },
      {
        value: '530900',
      ...
      },
      {
        ...
        children: [
          ...
          { value: '533324', label: '贡山独龙族怒族县' },
          { value: '533325', label: '兰坪白族普米族县' },
        ],
      },
      {
        value: '533400',
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { value: '542621', label: '工布江达县' },
          { value: '542621', label: '米林县' },
          { value: '542621', label: '墨脱县' },
          { value: '542621', label: '波密县' },
          { value: '542621', label: '察隅县' },
          { value: '542621', label: '朗县' },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        label: '嘉峪关市',
        children: [
          { value: '620201', label: '镜铁区' },
          { value: '620201', label: '长城区' },
    ...
    children: [
      {
        ...
        label: '台北市',
        children: [
          { value: '6300100', label: '松山区' },
          { value: '6300200', label: '信义区' },
          { value: '6300300', label: '大安区' },
          { value: '6300400', label: '中山区' },
          { value: '6300500', label: '中正区' },
          { value: '6300600', label: '大同区' },
          { value: '6300700', label: '万华区' },
          { value: '6300800', label: '文山区' },
          { value: '6300900', label: '南港区' },
          { value: '6301000', label: '内湖区' },
          { value: '6301100', label: '士林区' },
          { value: '6301200', label: '北投区' },
        ],
      },
      {
        value: '64',
        label: '高雄市',
        children: [
          { value: '6400100', label: '盐埕区' },
          { value: '6400200', label: '鼓山区' },
          { value: '6400300', label: '左营区' },
          { value: '6400400', label: '楠梓区' },
          { value: '6400500', label: '三民区' },
          { value: '6400600', label: '新兴区' },
          { value: '6400700', label: '前金区' },
          { value: '6400800', label: '苓雅区' },
          { value: '6400900', label: '前镇区' },
          { value: '6401000', label: '旗津区' },
          { value: '6401100', label: '小港区' },
        ],
      },
      {
        value: '10017',
        label: '基隆市',
        children: [
          { value: '1001701', label: '中正区' },
          { value: '1001702', label: '七堵区' },
          { value: '1001703', label: '暖暖区' },
          { value: '1001704', label: '仁爱区' },
          { value: '1001705', label: '中山区' },
          { value: '1001706', label: '安乐区' },
          { value: '1001707', label: '信义区' },
        ],
      },
      {
        value: '10019',
        ...
        children: [
          ...
          { value: '', label: '大里区' },
          { value: '', label: '太平区' },
          { value: '1001901', label: '中区' },
          { value: '1001902', label: '东区' },
          { value: '1001903', label: '南区' },
          { value: '1001904', label: '西区' },
          { value: '1001905', label: '北区' },
          { value: '1001906', label: '西屯区' },
          { value: '1001907', label: '南屯区' },
          { value: '1001908', label: '北屯区' },
        ],
      },
      {
        value: '10021',
        label: '台南市',
        children: [
          { value: '1002101', label: '东区' },
          { value: '1002102', label: '南区' },
          { value: '1002104', label: '北区' },
          { value: '1002106', label: '安南区' },
          { value: '1002107', label: '安平区' },
          { value: '1002108', label: '中西区' },
        ],
      },
      {
        value: '10018',
        label: '新竹市',
        children: [
          { value: '1001801', label: '东区' },
          { value: '1001802', label: '北区' },
          { value: '1001803', label: '香山区' },
        ],
      },
      {
        value: '10020',
        label: '嘉义市',
        children: [
          { value: '1002001', label: '东区' },
          { value: '1002002', label: '西区' },
        ],
      },
      {
        value: '',
      ...
      },
      {
        ...
        label: '宜兰县',
        children: [
          { value: '1000201', label: '宜兰市' },
          { value: '1000202', label: '罗东镇' },
          { value: '1000203', label: '苏澳镇' },
          { value: '1000204', label: '头城乡' },
          { value: '1000205', label: '礁溪乡' },
          { value: '1000206', label: '壮围乡' },
          { value: '1000207', label: '员山乡' },
          { value: '1000208', label: '冬山乡' },
          { value: '1000209', label: '五结乡' },
          { value: '1000210', label: '三星乡' },
          { value: '1000211', label: '大同乡' },
          { value: '1000212', label: '南澳乡' },
        ],
      },
      {
        value: '10003',
        label: '桃园县',
        children: [
          { value: '1000301', label: '桃园市' },
          { value: '1000302', label: '中坜市' },
          { value: '1000303', label: '大溪镇' },
          { value: '1000304', label: '杨梅镇' },
          { value: '1000305', label: '芦竹乡' },
          { value: '1000306', label: '大园乡' },
          { value: '1000307', label: '龟山乡' },
          { value: '1000308', label: '八德市' },
          { value: '1000309', label: '龙潭乡' },
          { value: '1000310', label: '平镇市' },
          { value: '1000311', label: '新屋乡' },
          { value: '1000312', label: '观音乡' },
          { value: '1000313', label: '复兴乡' },
        ],
      },
      {
        value: '10004',
        label: '新竹县',
        children: [
          { value: '1000401', label: '竹北市' },
          { value: '1000402', label: '竹东镇' },
          { value: '1000403', label: '新埔镇' },
          { value: '1000404', label: '关西镇' },
          { value: '1000405', label: '湖口乡' },
          { value: '1000406', label: '新丰乡' },
          { value: '1000407', label: '芎林乡' },
          { value: '1000408', label: '横山乡' },
          { value: '1000409', label: '北埔乡' },
          { value: '1000410', label: '宝山乡' },
          { value: '1000411', label: '峨眉乡' },
          { value: '1000412', label: '尖石乡' },
          { value: '1000413', label: '五峰乡' },
        ],
      },
      {
        value: '10005',
        label: '苗栗县',
        children: [
          { value: '1000501', label: '苗栗市' },
          { value: '1000502', label: '苑里镇' },
          { value: '1000503', label: '通霄镇' },
          { value: '1000504', label: '竹南镇' },
          { value: '1000505', label: '头份镇' },
          { value: '1000506', label: '后龙镇' },
          { value: '1000507', label: '卓兰镇' },
          { value: '1000508', label: '大湖乡' },
          { value: '1000509', label: '公馆乡' },
          { value: '1000510', label: '铜锣乡' },
          { value: '1000511', label: '南庄乡' },
          { value: '1000512', label: '头屋乡' },
          { value: '1000513', label: '三义乡' },
          { value: '1000514', label: '西湖乡' },
          { value: '1000515', label: '造桥乡' },
          { value: '1000516', label: '三湾乡' },
          { value: '1000517', label: '狮潭乡' },
          { value: '1000518', label: '泰安乡' },
        ],
      },
      {
        value: '10007',
        label: '彰化县',
        children: [
          { value: '1000701', label: '彰化市' },
          { value: '1000702', label: '鹿港镇' },
          { value: '1000703', label: '和美镇' },
          { value: '1000704', label: '线西乡' },
          { value: '1000705', label: '伸港乡' },
          { value: '1000706', label: '福兴乡' },
          { value: '1000707', label: '秀水乡' },
          { value: '1000708', label: '花坛乡' },
          { value: '1000709', label: '芬园乡' },
          { value: '1000710', label: '员林镇' },
          { value: '1000711', label: '溪湖镇' },
          { value: '1000712', label: '田中镇' },
          { value: '1000713', label: '大村乡' },
          { value: '1000714', label: '埔盐乡' },
          { value: '1000715', label: '埔心乡' },
          { value: '1000716', label: '永靖乡' },
          { value: '1000717', label: '社头乡' },
          { value: '1000718', label: '二水乡' },
          { value: '1000719', label: '北斗镇' },
          { value: '1000720', label: '二林镇' },
          { value: '1000721', label: '田尾乡' },
          { value: '1000722', label: '埤头乡' },
          { value: '1000723', label: '芳苑乡' },
          { value: '1000724', label: '大城乡' },
          { value: '1000725', label: '竹塘乡' },
          { value: '1000726', label: '溪州乡' },
        ],
      },
      {
        value: '10008',
        label: '南投县',
        children: [
          { value: '1000801', label: '南投市' },
          { value: '1000802', label: '南投镇' },
          { value: '1000803', label: '草屯镇' },
          { value: '1000804', label: '竹山镇' },
          { value: '1000805', label: '集集镇' },
          { value: '1000806', label: '名间乡' },
          { value: '1000807', label: '鹿谷乡' },
          { value: '1000808', label: '中寮乡' },
          { value: '1000809', label: '鱼池乡' },
          { value: '1000810', label: '国姓乡' },
          { value: '1000811', label: '水里乡' },
          { value: '1000812', label: '信义乡' },
          { value: '1000813', label: '仁爱乡' },
        ],
      },
      {
        value: '10009',
        label: '云林县',
        children: [
          { value: '1000901', label: '斗六市' },
          { value: '1000902', label: '斗南镇' },
          { value: '1000903', label: '虎尾镇' },
          { value: '1000904', label: '西螺镇' },
          { value: '1000905', label: '土库镇' },
          { value: '1000906', label: '北港镇' },
          { value: '1000907', label: '古坑乡' },
          { value: '1000908', label: '大埤乡' },
          { value: '1000909', label: '莿桐乡' },
          { value: '1000910', label: '林内乡' },
          { value: '1000911', label: '二仑乡' },
          { value: '1000912', label: '仑背乡' },
          { value: '1000913', label: '麦寮乡' },
          { value: '1000914', label: '东势乡' },
          { value: '1000915', label: '褒忠乡' },
          { value: '1000916', label: '台西乡' },
          { value: '1000917', label: '元长乡' },
          { value: '1000918', label: '四湖乡' },
          { value: '1000919', label: '口湖乡' },
          { value: '1000920', label: '水林乡' },
        ],
      },
      {
        value: '10020',
        ...
        children: [
          ...
          { value: '', label: '朴子市' },
          { value: '', label: '布袋镇' },
          { value: '10010', label: '大林镇' },
          { value: '1001001', label: '民雄乡' },
          { value: '1001002', label: '溪口乡' },
          { value: '1001003', label: '新港乡' },
          { value: '1001004', label: '六脚乡' },
          { value: '1001005', label: '东石乡' },
          { value: '1001006', label: '义竹乡' },
          { value: '1001007', label: '鹿草乡' },
          { value: '1001008', label: '水上乡' },
          { value: '1001009', label: '中埔乡' },
          { value: '1001010', label: '竹崎乡' },
          { value: '1001011', label: '梅山乡' },
          { value: '1001012', label: '番路乡' },
          { value: '1001013', label: '大埔乡' },
          { value: '1001014', label: '阿里山乡' },
        ],
      },
      {
        value: '10013',
        label: '屏东县',
        children: [
          { value: '1001301', label: '屏东市' },
          { value: '1001302', label: '潮州镇' },
          { value: '1001303', label: '东港镇' },
          { value: '1001304', label: '恒春镇' },
          { value: '1001305', label: '万丹乡' },
          { value: '1001306', label: '长治乡' },
          { value: '1001307', label: '麟洛乡' },
          { value: '1001308', label: '九如乡' },
          { value: '1001309', label: '里港乡' },
          { value: '1001310', label: '盐埔乡' },
          { value: '1001311', label: '高树乡' },
          { value: '1001312', label: '万峦乡' },
          { value: '1001313', label: '内埔乡' },
          { value: '1001314', label: '竹田乡' },
          { value: '1001315', label: '新埤乡' },
          { value: '1001316', label: '枋寮乡' },
          { value: '1001317', label: '新园乡' },
          { value: '1001318', label: '崁顶乡' },
          { value: '1001319', label: '林边乡' },
          { value: '1001320', label: '南州乡' },
          { value: '1001321', label: '佳冬乡' },
          { value: '1001322', label: '琉球乡' },
          { value: '1001323', label: '车城乡' },
          { value: '1001324', label: '满州乡' },
          { value: '1001325', label: '枋山乡' },
          { value: '1001326', label: '三地门乡' },
          { value: '1001327', label: '雾台乡' },
          { value: '1001328', label: '玛家乡' },
          { value: '1001329', label: '泰武乡' },
          { value: '1001330', label: '来义乡' },
          { value: '1001331', label: '春日乡' },
          { value: '1001332', label: '狮子乡' },
          { value: '1001333', label: '牡丹乡' },
        ],
      },
      {
        value: '10014',
        ...
        children: [
          { value: '', label: '卑南乡' },
          { value: '1001401', label: '台东市' },
          { value: '1001402', label: '成功镇' },
          { value: '1001403', label: '关山镇' },
          { value: '1001405', label: '鹿野乡' },
          { value: '1001406', label: '池上乡' },
          { value: '1001407', label: '东河乡' },
          { value: '1001408', label: '长滨乡' },
          { value: '1001409', label: '太麻里乡' },
          { value: '1001410', label: '大武乡' },
          { value: '1001411', label: '绿岛乡' },
          { value: '1001412', label: '海端乡' },
          { value: '1001413', label: '延平乡' },
          { value: '1001414', label: '金峰乡' },
          { value: '1001415', label: '达仁乡' },
          { value: '1001416', label: '兰屿乡' },
        ],
      },
      {
        value: '10015',
        label: '花莲县',
        children: [
          { value: '1001501', label: '花莲市' },
          { value: '1001502', label: '凤林镇' },
          { value: '1001503', label: '玉里镇' },
          { value: '1001504', label: '新城乡' },
          { value: '1001505', label: '吉安乡' },
          { value: '1001506', label: '寿丰乡' },
          { value: '1001507', label: '光复乡' },
          { value: '1001508', label: '丰滨乡' },
          { value: '1001509', label: '瑞穗乡' },
          { value: '1001510', label: '富里乡' },
          { value: '1001511', label: '秀林乡' },
          { value: '1001512', label: '万荣乡' },
          { value: '1001513', label: '卓溪乡' },
        ],
      },
      {
        value: '10016',
        label: '澎湖县',
        children: [
          { value: '1001601', label: '马公市' },
          { value: '1001602', label: '湖西乡' },
          { value: '1001603', label: '白沙乡' },
          { value: '1001604', label: '西屿乡' },
          { value: '1001605', label: '望安乡' },
          { value: '1001606', label: '七美乡' },
        ],
      },
      { value: '', label: '连江县' },
      { value: '', label: '金门县' },
